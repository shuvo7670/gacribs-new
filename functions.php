...
function wpestate_shortcode_display() {
	?><div class="header_wrapper header_type1 header_align_center"><?php
    require_once get_theme_file_path('/templates/top_user_menu.php');?>
	</div><?php
}
add_shortcode('user_role_switcher', 'wpestate_shortcode_display');


//require_once get_theme_file_path('/libs/debug-functions.php');
